"""
COPY OF https://github.com/tensorflow/cleverhans/blob/master/cleverhans_tutorials/mnist_tutorial_jsma.py
...
from cleverhans.plot.pyplot_image import pair_visual, grid_visual
...
def mnist_tutorial_jsma(train_start=0, train_end=6000, test_start=0,
                        test_end=1000, viz_enabled=VIZ_ENABLED,
